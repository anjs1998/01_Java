...
public class CharacterService {
	...
	public void fileInput() {
		...
		try {
			...
			String line = null; // 한 줄을 읽어 와 저장할 변수
			...
			while(true) {
				...
				if(line == null) { break;} // 더이상 읽어올 내용이 없을때 반복 종료
	...
	public void fileOutput() {
		...
		//스트림 참조변수 선언
		FileWriter fw = null; // 문자기반 파일출력 스트림
		
		BufferedWriter bw = null; // 문자출력 보조 스트림
